      ...
      <main class="min-h-screen w-full">
        <nav class="flex justify-between px-10 bg-white py-6">
          <div class="flex items-center bg-gray-100 px-4 py-1 rounded-md space-x-3 w-96">
            <input type="text" name="search" id="search" placeholder="search student name" class="bg-gray-100 border-none outline-none focus:border-transparent focus:ring-0 w-full" />
        ...
        <div class="bg-white rounded-md w-full">
          <div class="flex items-center justify-between pb-6">
            ...
            <div class="flex items-center justify-between">
                <div class="lg:ml-40 ml-10 space-x-8">
                  <button onclick="window.location.href='/create'" class="bg-green-500 hover:bg-green-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer">New Student</button>
                </div>
              </div>
            </div>
            <div>
                      ...
                      @foreach ($students as $student)
                        <tr>
                          <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <div class="flex items-center">
                              <div class="ml-3"> <a href="/show/{{$student->id}}">
                          ...
                          <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            ...
                            <span class="relative">{{$student->mobile}}</span>
                            </span>
                          </td>
                        </tr>
                      @endforeach
          ...
          <a href="/"><i class="fa fa-close hover:text-red-500" style="font-size: 25px"></i></a>
            <section>
              @include('components.create_new_student')
            </section>
